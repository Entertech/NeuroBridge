#ifndef B45422AE_236E_4708_B5DD_98D630F7698D
#define B45422AE_236E_4708_B5DD_98D630F7698D
#include "Basic.hpp"
#include <vector>
#include <deque>
namespace basic
{
    namespace mathtool
    {
        ...
        bool isprime(T n)
        {
            ...
            if (n <= 1)
                throw std::invalid_argument("Prime/Composite test should bigger than 1");
            if (n == 2)
                return true;
            if (n % 2 == 0)
                return false;
...
#endif /* B45422AE_236E_4708_B5DD_98D630F7698D */
