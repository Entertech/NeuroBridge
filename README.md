...
| Windows 网关 | [`windows/README.md`](windows/README.md)；[PowerShell 操作教程](doc/tech/麒麟V10网关运行与串口联调内部文档.md#10-windows-操作教程源码联调) | 已有 COM/Service/unsigned 候选源码与源码联调步骤，Windows 7 运行时、签名和实机验收未完成，不能作为交付入口。 |
