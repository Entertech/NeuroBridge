...
class DeploymentTests(unittest.TestCase):
    ...
    def test_ssh_operations_are_explicitly_enabled_and_password_authenticated(self) -> None:
        ...
        self.assertIn('release_owner=${SUDO_USER:-}', script)
        self.assertIn("Staged release must be owned by $release_owner", script)
        self.assertIn('chown "$operator_user:$operator_user" "$update_source_dir"', script)
